...
import { fetchCategories } from "@/lib/store/institute/category/categoryInstituteSlice";
                    ...
                    category.map((categories: ICategoryData) => {
                      return (
                        ...
                        >
                          ...
                          <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                            {categories?.categoryDescription.substring(0, 50)}
                          </td>
                          <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                            {new Date(
...
export default InstituteCategoriesDashboard;
