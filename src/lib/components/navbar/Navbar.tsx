  ...
  <div className="mx-auto max-w-7xl px-6 sm:px-6 lg:px-8 ">
    <div className="relative flex h-16 justify-between">
      ...
      <div className="flex-shrink-0 flex px-2 py-3 items-center space-x-8">
        ...
        <a className="text-gray-800 bg-blue-500 hover:bg-blue-700 inline-flex items-center justify-center px-3 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm " href="#">Become an Institute
        </a>
      </div>
    </div>
  </div>
